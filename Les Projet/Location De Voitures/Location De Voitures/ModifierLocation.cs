...
{
    public partial class ModifierLocation : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (index == 0)
            {
                MessageBox.Show("Veuillez selectionner la Location a Modifier avant de cliquer Modifier", "Erreur", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
            {
                this.Hide();
                ML2 l = new ML2(dataGridView1.CurrentRow.Cells[0].Value.ToString(), dataGridView1.CurrentRow.Cells[1].Value.ToString(), dataGridView1.CurrentRow.Cells[2].Value.ToString(), dataGridView1.CurrentRow.Cells[7].Value.ToString(), dataGridView1.CurrentRow.Cells[8].Value.ToString(),Convert.ToDateTime( dataGridView1.CurrentRow.Cells[5].Value.ToString()),Convert.ToDateTime( dataGridView1.CurrentRow.Cells[6].Value.ToString()));
                l.ShowDialog();
                this.Close();
            }
        }
