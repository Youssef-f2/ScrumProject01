...
{
    public partial class SupprimerLocation : Form
    {
        ...
        {
            pictureBox3.BackColor = System.Drawing.Color.IndianRed;
        ...
        private void button13_MouseLeave(object sender, EventArgs e)
        {
            ...
            pictureBox3.BackColor = System.Drawing.Color.LightCoral;
        }
        ...
        private void button13_Click(object sender, EventArgs e)
        {
            ...
            if (index == 0)
            {
                MessageBox.Show("Veuillez selectionner la ligne a supprimer avant de cliquer Supprimer", "Erreur", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
            {
                if (MessageBox.Show("Voulez-vous vraiment supprimer la Location du Voiture " + dataGridView1.CurrentRow.Cells[2].Value.ToString() + " a Monsieur " + dataGridView1.CurrentRow.Cells[3].Value.ToString() + " ?", "Confirmation", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
                {
                    o.conex();
                    o.cmd = new SqlCommand("Delete from Locations where IdLocation ='" + dataGridView1.CurrentRow.Cells[0].Value.ToString() + "'", o.cn);
                    o.cmd.ExecuteNonQuery();
                    o.Deconex();
                    MessageBox.Show("Location est bien Supprime", "Supression Efectuer", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    o.conex();
                    o.cmd = new SqlCommand("Select IdLocation,IdVoiture,IdLocateur,Marque,NomLocateur,DateLocation,DateSoumission,NombreDeJour,PrixTotal from Locations", o.cn);
                    o.dr = o.cmd.ExecuteReader();
                    o.dt = new DataTable();
